...
(function($) {
  ...
  function loadPost1(){
    $.ajax({
       url: "webdev.html", // URL HERE
       type: 'GET',
       success: function(html) {
 
         var $lis = $(html).find('#blogPost1'); // Loads the content inside #blogPost div
 ...
 $(".loadPost1").on('click', function(event){
   event.preventDefault();
   //$("#postHere1").html('loading...');
   $('.section-page-active').removeClass('section-page-active');
   $('#page-blog-single1').addClass('section-page-active');
   pageOn();
   loadPost1();
 });
 ...
 function loadPost2(){
  $.ajax({
     url: "graphicdesign.html", // URL HERE
     type: 'GET',
     success: function(html) {

       var $lis = $(html).find('#blogPost2'); // Loads the content inside #blogPost div
...
$(".loadPost2").on('click', function(event){
 ...
 //$("#postHere1").html('loading...');
 $('.section-page-active').removeClass('section-page-active');
 $('#page-blog-single2').addClass('section-page-active');
 pageOn();
 loadPost2();
});
